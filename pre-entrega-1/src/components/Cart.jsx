                ...
                <div className="row">
                   ...
                   <h3 className="text-center" style={{color:"Orchid"}}>C A R R I T O 💌</h3><br /><br />
                        <table className="table">
                            <tbody>
                                <tr>
                                <td colSpan={5} className="text-end"><button className="btn btn-info text-white fw-bold" onClick={clear}>Vaciar carrito</button></td> 
                                </tr>
                                {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="align-middle text-center" style={{color:"DarkViolet"}}>$ {item.precio}</td>
                                    <td className="align-middle text-center" style={{color:"DarkViolet"}}>{item.quantity}</td>
